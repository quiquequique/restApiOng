...
class EmailData {
  constructor(fName, lName, email, key) {
    ...
    switch (key) {
      case 'registerEmail':
        this.emailText = TEXT_REGISTER;
        break;
      case 'newContact':
        this.emailText = TEXT_NEW_CONTACT;
        break;
      default:
        // eslint-disable-next-line no-console
        console.log('falla en switch email2.helpers line 17'); // prep for logger
    }
